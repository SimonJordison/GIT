...
def filtrar_superiores_al_promedio(velocidades):
    ...
    return [i for i, v in enumerate(velocidades) if v > valor_promedio]
...
print("Posiciones de las correas transportadoras con velocidades superiores al promedio:")
print(filtrar_superiores_al_promedio(velocidad))
